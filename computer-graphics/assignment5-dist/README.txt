...
Student name: Miska Tammenpää
Student number: 729637
Hours spent on requirements (approx.): 7h 30min
...
R6 Triangle intersection	          (1.5p): attempted, compiles but does not work as intended
...
# Are there any known problems/bugs remaining in your code?
	- Yes, triangle intersection does not work. The problem is probably caused by incorrect math
...
# Any other comments you'd like to share about the assignment or the course so far?
	- Quite an interesting assignment. Definitely should have started work on it earlier :)
